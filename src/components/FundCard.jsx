...
const FundCard = ({ owner, title, description, target, deadline, amount_collected,category, image, handleClick }) => {
  const remainingDays = daysLeft(deadline);
  
  return (
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
      <div className="p-2">
      <img src={image} alt="fund" className="w-full h-[170px] rounded-[15px] "/>
      </div>
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex justify-between flex-wrap mt-[15px] gap-2">
          <div className="flex flex-col">
            <h4 className="font-epilogue font-semibold text-[14px] text-[#b2b3bd] leading-[22px]">{amount_collected}</h4>
